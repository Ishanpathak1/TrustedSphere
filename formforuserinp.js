        ...
        <form action="">
            ...
            <div className="ForNo">
               <div className="ForNoText"> <label htmlFor="Noofprop">Number of property</label></div>
                <input type="text" required value={NooP} onChange={getNoop} name="NoofP" id="NoofP" className="ForNoInput"/>
            </div>
            <div className="ForName">
                <div className="ForNameText"><label htmlFor="Name">Name</label></div>
                <input type="text" required value={name} onChange={getName} name="Name" id="Name" className="ForNameInput"/>
            </div>
            ...
            <div className="RectangleForForm"></div>
              <input type="text" required value={Address1} onChange={getAddress1} name="Address1" id="Address1" className="ForAddressLine1"/>
              <input type="text" required value={Address2} onChange={getAddress2} name="Address2" id="Address2" className="ForAddressLine2"/>
              <input type="text" required value={City} onChange={getCity} name="City" id="City" className="ForCity"/>
              <input type="text" required value={State} onChange={getState}name="State" id="State" className="ForState"/>
              <input type="text" required value={Country} onChange={getCountry} name="Country" id="Country" className="ForCountry"/>
